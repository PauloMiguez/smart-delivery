    ...
    try {
        ...
        document.getElementById('admin-product-list').innerHTML = `
            <div class="empty-state">
                ...
                <p style="font-size:12px;color:#aaa;margin-top:8px;">${error.message}</p>
                <button class="btn btn-sm" onclick="loadData()" style="margin-top:12px;width:auto;">
                    🔄 Tentar novamente
                </button>
            </div>
        `;
    ...
    if (!products || products.length === 0) {
        container.innerHTML = `
            <div class="empty-state">
                ...
                <button class="btn btn-sm" onclick="openProductModal()" style="margin-top:12px;width:auto;">
    ...
    if (!categories || categories.length === 0) {
        container.innerHTML = `
            <div class="empty-state">
                ...
                <button class="btn btn-sm btn-primary" onclick="openCategoryModal()" style="margin-top:12px;width:auto;">
